...
function Controls(props) {
  ...
  return (
    <div className='controls'>
      <button className="btn btn-outline-success open-modal control-btn" onClick={()=>{props.onGeneration(props.gridSize, props.pointPercentage)}} type="button">Generate data</button>
